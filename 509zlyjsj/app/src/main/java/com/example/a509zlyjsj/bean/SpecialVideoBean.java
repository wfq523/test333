package com.example.a509zlyjsj.bean;
...
public class SpecialVideoBean {
     ...
     * id : 84
     * name : Spinner实例
     * thumb : video/thumb/20161031/20161031114934_115702039.jpg
     * thumbsize : 45K
     * description : Android Spinner实例
     * videopath : zjs-android/1.mp4
     * specialid : 42
     * specialname : Android-高级控件（课堂实录）
     * srcsc : null
     * srcscsize : null
     * donesc : video/donesc/20161013/20161013024352_1493367339.zip
     * donescsize : 1.64M
     * technoid : 17
     * technoname : Android
     * kcdm : drandroid
     ...
     * hits : 564
     * insert_time : null
     * update_time : 2016-10-13 12:49:36
     * check_userid : 1
     * checktime : null
     * checkstate : 1
     * listorder : 1
    ...
    public String getSphits() {
        return sphits;
    }

    public void setSphits(String sphits) {
        this.sphits = sphits;
    }
}
