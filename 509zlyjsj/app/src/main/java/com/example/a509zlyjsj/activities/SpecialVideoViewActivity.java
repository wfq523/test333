...
public class SpecialVideoViewActivity extends AppCompatActivity {
    private int resid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setMediaController(new MediaController(SpecialVideoViewActivity.this));
        ...
        class MyPlayerOnCompletionListener implements MediaPlayer.OnCompletionListener {
            ...
            public void onCompletion(MediaPlayer mp) {
                Toast.makeText(SpecialVideoViewActivity.this, "播放完成了", Toast.LENGTH_SHORT).show();
            }
        }
        //播放完成回调
