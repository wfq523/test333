...
import com.example.a509zlyjsj.activities.SpecialVideoViewActivity;
...
public class SpecialVideoAdapter extends RecyclerView.Adapter {
    private List<SpecialVideoBean> list;//向rv中填充的数据
    ...
    //自定义 设置数据list
    public void setList(List<SpecialVideoBean> list)
    {
        this.list=list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        final SpecialVideoBean  bean=list.get(position);
        if(bean==null)
            return;
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(context, SpecialVideoViewActivity.class);
