...
import com.example.a509zlyjsj.adapter.TcaseAdapter;
...
public class Fragment41 extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        System.out.println("--f41--"+getSessionId());
        initRecyclerView(view);
        ArticleModel model=new ArticleModel();
        model.getResultList("tcase",page,getSessionId(),listener);//页码默认第一页
    }
    private void initRecyclerView(View view) {
        recyclerView=view.findViewById(R.id.XRecyclerView41);
        ...
        recyclerView.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onRefresh() {
                ...
                page = 1;
                ArticleModel model = new ArticleModel();
                model.getResultList("tcase", page, getSessionId(), listener);
